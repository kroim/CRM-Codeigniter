...
<!-- Search Inputtext : HTML -->
    ...
    <table id="myTable" style="font-size: <?php echo $fontsize;?>px;">
        ...
        {
        echo ("<tr id='tr-".$clients[$i]->PK_clientID."' ondblclick='updata_clients(". $clients[$i]->PK_clientID .")'>");
            ...
            echo
            ("<td class='check'><input class='allcheck' type='checkbox' name='checkid[]' value='".$clients[$i]->PK_clientID."' id='check'></td>"
